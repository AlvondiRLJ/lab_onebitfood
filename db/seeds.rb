...
r = Restaurant.create!(
    name: 'Ola Que Tal',
    description: 'Para alcançar e manter essa distinção em comida e vinho, serviço e ambiente, o restaurante ganha reputação de primeira classe por gastronomia, hospitalidade graciosa e informada, conforto e beleza que atraem clientes novos e repetidos ano após ano',
    status: 'open', delivery_tax: 5.50,
